...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivisen_summan_lataaminen_ei_lisaa_saldoa(self):
        self.kortti.lataa_rahaa(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")
 
    def test_pystyy_ostamaan_edullisen_jos_vain_edullisesti_rahaa(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_pystyy_ostamaan_maukkaan_jos_vain_maukkaasti_rahaa(self):
